<nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <div>
                <div class="">
                    ...
                    <div class="inner-text">
                        ...
                        <h5 class="px-3">19/BIT/031/UMC</h5>
                    </div>
                </div>
            </div>
            <br>
            ...
            <ul class="nav-bar" id="main-menu">
                <li>
                    <a class="active-menu fs-4 text-light" href="#">Payments</a>
                </li>
                <br>
                <li>
                    <a class="fs-4 text-light" href="#">Cleared</a>
                </li>
                <br>
                <li>
                    <a class="fs-4 text-light" href="#">Balances</a>
                </li>
            </ul>
        </div>
    </nav>