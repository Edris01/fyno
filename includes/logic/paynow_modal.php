        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="../../includes/logic/pay.php" method="post">
                    ...
                    <!-- i need most of the database to be printed automatically picked from the database than the user filling it in  -->
                    <!-- <div class="mb-3">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="pay" class="btn btn-success"><i class="bi bi-send"></i> Send</button>
                    </div>
                </form>
            </div>
        </div>
